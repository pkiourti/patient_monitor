...
class Device(Resource):
    def get(self, device_id):
        ...
        return device_module.get_device(json_data)
...
class DeviceType(Resource):
    def get(self, device_type_id):
        ...
        return device_type_module.get_device_type(json_data)

class DeviceTypeList(Resource):
    def get(self):
        return device_type.get_device_types()
...
class DeviceAssignment(Resource):
    def get(self, assignment_id):
        ...
        return device_assignment_module.get_assignment(json_data)
...
class DeviceAssignmentList(Resource):
    ...
    def post(self):
        ...
        return {"data": {"assignment_id": assignment_id}}

class DeviceMeasurement(Resource):
    def get(self, measurement_id):
        json_data = json.dumps({"measurement_id": str(measurement_id)})
        return device_measurement_module.get_measurement(json_data)
...
class DeviceMeasurementList(Resource):
    ...
    def post(self):
        ...
        return {"data": {"measurement_id": measurement_id}}
